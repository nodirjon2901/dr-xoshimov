package uz.result.drxoshimov.bot;
...
public class ApplyNotifierBot extends TelegramWebhookBot {
    ...
    public void handleSendApplication(Application application) {
        ...
        sendMessage.setChatId(botGroupChatId);
        sendMessage.setParseMode("Markdown");
        sendMessage.setText(
                "*Новая заявка*\n\n" +
                        "\uD83D\uDC64 *ФИО*: " + application.getName() + "\n" +
                        "\uD83D\uDCDE *Номер телефона*: " + application.getPhone() + "\n" +
